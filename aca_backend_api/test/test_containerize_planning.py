...
class TestPlan(unittest.TestCase):
    ...
    def test_ui_to_input_assessment(self):
        ...
        expected = [{'application_name': 'App Name 0114', 'application_description': 'App Desc 0114', 'component_name': 'Comp 1', 'OS': {'RHEL': {'Linux|Red Hat Enterprise Linux': ''}}, 'Lang': {'Java': {'Java': ''}}, 'App Server': {'WebSphere Application Server': {'Websphere Application Server (WAS)': ''}}, 'App': {'db2 10.0': {'DB2': '10.0'}, 'Redis': {'Redis': ''}, 'jenkins': {'Jenkins': ''}}, 'Runtime': {}, 'Lib': {'angularJs': {'JavaScript|AngularJS': ''}, 'express.js': {'JavaScript|Express.js': ''}}, 'assessment_reason': '', 'KG Version': '1.0.1'}]
    ...
    def test_validate_app(self):
        ...
        expected = [{'application_name': 'App Name 0114', 'application_description': 'App Desc 0114', 'component_name': 'Comp 1', 'OS': {'RHEL': {'Linux|Red Hat Enterprise Linux': ''}}, 'Lang': {'Java': {'Java': ''}}, 'App Server': {'WebSphere Application Server': {'Websphere Application Server (WAS)': ''}}, 'App': {'db2 10.0': {'DB2': '10.0'}, 'Redis': {'Redis': ''}, 'jenkins': {'Jenkins': ''}}, 'Runtime': {}, 'Lib': {'angularJs': {'JavaScript|AngularJS': ''}, 'express.js': {'JavaScript|Express.js': ''}}, 'assessment_reason': '', 'KG Version': '1.0.1', 'valid_assessment': True}]
    ...
    def test_infer_missing_tech(self):
        inferTech = InferTech()
        appL = [{'application_name': 'App Name 0114', 'application_description': 'App Desc 0114', 'component_name': 'Comp 1', 'OS': {'RHEL': {'Linux|Red Hat Enterprise Linux': ''}}, 'Lang': {'Java': {'Java': ''}}, 'App Server': {'WebSphere Application Server': {'Websphere Application Server (WAS)': ''}}, 'App': {'db2 10.0': {'DB2': '10.0'}, 'Redis': {'Redis': ''}, 'jenkins': {'Jenkins': ''}}, 'Runtime': {}, 'Lib': {'angularJs': {'JavaScript|AngularJS': ''}, 'express.js': {'JavaScript|Express.js': ''}}, 'assessment_reason': '', 'KG Version': '1.0.1', 'valid_assessment': True}]
        expected = [{'application_name': 'App Name 0114', 'application_description': 'App Desc 0114', 'component_name': 'Comp 1', 'OS': {'RHEL': {'Linux|Red Hat Enterprise Linux': ''}}, 'Lang': {'Java': {'Java': ''}, 'angularJs': {'JavaScript': ''}}, 'App Server': {'WebSphere Application Server': {'Websphere Application Server (WAS)': ''}}, 'App': {'db2 10.0': {'DB2': '10.0'}, 'Redis': {'Redis': ''}, 'jenkins': {'Jenkins': ''}}, 'Runtime': {}, 'Lib': {'angularJs': {'JavaScript|AngularJS': ''}, 'express.js': {'JavaScript|Express.js': ''}}, 'assessment_reason': '', 'KG Version': '1.0.1', 'valid_assessment': True, 'VM': {}, 'Technology': {}, 'Storage': {}, 'Plugin': {}, 'Runlib': {}, 'HW': {}, 'Inferred': {'Lang': ['JavaScript'], 'App': [], 'App Server': [], 'Runtime': [], 'OS': []}, 'Recommended OS': 'Linux', 'Linux': {'Lang': ['Java', 'JavaScript'], 'App': ['DB2', 'Redis', 'Jenkins'], 'App Server': ['Websphere Application Server (WAS)'], 'Runtime': []}, 'Windows': {'Lang': [], 'App': [], 'App Server': [], 'Runtime': []}, 'RepackageOS': ['Linux']}]
    ...
    def test_map_to_docker(self):
        plan = Plan()
        appL = [{'application_name': 'App Name 0114', 'application_description': 'App Desc 0114', 'component_name': 'Comp 1', 'OS': {'RHEL': {'Linux|Red Hat Enterprise Linux': ''}}, 'Lang': {'Java': {'Java': ''}, 'angularJs': {'JavaScript': ''}}, 'App Server': {'WebSphere Application Server': {'Websphere Application Server (WAS)': ''}}, 'App': {'db2 10.0': {'DB2': '10.0'}, 'Redis': {'Redis': ''}, 'jenkins': {'Jenkins': ''}}, 'Runtime': {}, 'Lib': {'angularJs': {'JavaScript|AngularJS': ''}, 'express.js': {'JavaScript|Express.js': ''}}, 'assessment_reason': '', 'KG Version': '1.0.1', 'valid_assessment': True, 'VM': {}, 'Runlib': {}, 'Plugin': {}, 'Technology': {}, 'HW': {}, 'Storage': {}, 'Inferred': {'Lang': ['JavaScript'], 'App': [], 'App Server': [], 'Runtime': [], 'OS': []}, 'Recommended OS': 'Linux', 'Linux': {'Lang': ['Java', 'JavaScript'], 'App': ['DB2', 'Redis', 'Jenkins'], 'App Server': ['Websphere Application Server (WAS)'], 'Runtime': []}, 'Windows': {'Lang': [], 'App': [],'App Server': [], 'Runtime': []}, 'RepackageOS': ['Linux']}]
    ...
    def test_map_to_docker_openshift(self):
        plan = Plan()
        appL =  [{'application_name': 'App Name 0114', 'application_description': 'App Desc 0114', 'component_name': 'Comp 1', 'OS': {'RHEL': {'Linux|Red Hat Enterprise Linux': ''}}, 'Lang': {'Java': {'Java': ''}, 'angularJs': {'JavaScript': ''}}, 'App Server': {'WebSphere Application Server': {'Websphere Application Server (WAS)': ''}}, 'App': {'db2 10.0': {'DB2': '10.0'}, 'Redis': {'Redis': ''}, 'jenkins': {'Jenkins': ''}}, 'Runtime': {}, 'Lib': {'angularJs': {'JavaScript|AngularJS': ''}, 'express.js': {'JavaScript|Express.js': ''}}, 'assessment_reason': '', 'KG Version': '1.0.1', 'valid_assessment': True, 'VM': {}, 'Runlib': {}, 'Plugin': {}, 'Technology': {}, 'HW': {}, 'Storage': {}, 'Inferred': {'Lang': ['JavaScript'], 'App': [], 'App Server': [], 'Runtime': [], 'OS': []}, 'Recommended OS': 'Linux', 'Linux': {'Lang': ['Java', 'JavaScript'], 'App': ['DB2', 'Redis', 'Jenkins'], 'App Server': ['Websphere Application Server (WAS)'], 'Runtime': []}, 'Windows': {'Lang': [], 'App': [],'App Server': [], 'Runtime': []}, 'RepackageOS': ['Linux']}]
        expected =   [{'application_name': 'App Name 0114', 'application_description': 'App Desc 0114', 'component_name': 'Comp 1', 'OS': {'RHEL': {'Linux|Red Hat Enterprise Linux': ''}}, 'Lang': {'Java': {'Java': ''}, 'angularJs': {'JavaScript': ''}}, 'App Server': {'WebSphere Application Server': {'Websphere Application Server (WAS)': ''}}, 'App': {'db2 10.0': {'DB2': '10.0'}, 'Redis': {'Redis': ''}, 'jenkins': {'Jenkins': ''}}, 'Runtime': {}, 'Lib': {'angularJs': {'JavaScript|AngularJS': ''}, 'express.js': {'JavaScript|Express.js': ''}}, 'assessment_reason': '', 'KG Version': '1.0.1', 'valid_assessment': True, 'VM': {}, 'Runlib': {}, 'Plugin': {}, 'Technology': {}, 'HW': {}, 'Storage': {}, 'Inferred': {'Lang': ['JavaScript'], 'App': [], 'App Server': [], 'Runtime': [], 'OS': []}, 'Recommended OS': 'Linux', 'Linux': {'Lang': ['Java', 'JavaScript'], 'App': ['DB2', 'Redis', 'Jenkins'], 'App Server': ['Websphere Application Server (WAS)'], 'Runtime': []}, 'Windows': {'Lang': [], 'App': [], 'App Server': [], 'Runtime': []}, 'RepackageOS': ['Linux'], 'valid_planning': True, 'planning_reason': '', 'scope_images': {'websphere-traditional': {'Docker_URL': 'https://catalog.redhat.com/software/containers/r/ibmcom/websphere-traditional/5d77b2e4702c566f4cbf438b', 'Status': ''}, 'db2': {'Docker_URL': 'https://catalog.redhat.com/software/containers/ibm/ibm-db2z-ui/5d8bd4bf69aea310b5373e17', 'Status': ''}, 'redis_Linux': {'Docker_URL': 'https://catalog.redhat.com/software/containers/rhel8/redis-5/5c401b0cbed8bd75a2c4c287', 'Status': ''}, 'jenkins': {'Docker_URL': 'https://catalog.redhat.com/software/containers/openshift3/jenkins-2-rhel7/581d2f4500e5d05639b6517b', 'Status': ''}}, 'scope_images_confidence': {'mapping': {'Websphere Application Server (WAS)': 'websphere-traditional', 'DB2': 'db2', 'Redis': 'redis_Linux', 'Jenkins': 'jenkins'}, 'image_confidence': 0.929, 'images_score': 130, 'cum_scores': 140, 'custom_installations_needed': ['JavaScript'], 'custom_images_needed': []}}]
